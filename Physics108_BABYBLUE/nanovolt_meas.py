...
def main():
	...
	file = open("C:/Users/Student/physics108/Physics108_BABYBLUE/data/testdata" + timestamp + ".txt", "w")
	...
	while(True):
		...
		if enable_2:
			...
			# sys.stdout.write('Mod current (uA): ' + str(multi_2_current) + '\r')
		...
		if enable_3:
			...
			#sys.stdout.write('Squid Current (uA): ' + str(multi_3_current) + '\r')
